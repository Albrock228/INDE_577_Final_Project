...
def plot_decision_boundary(X, y, model, title):
    ...
    plt.show(block=True)  # Force blocking to display plots properly
...
def synthetic_test():
    ...
    plot_decision_boundary(X_synthetic, y_synthetic, model, 
                           "Decision Tree Decision Boundary (Synthetic Data)")
...
def real_data_test():
    ...
    plot_decision_boundary(X, y, model, 
                           "Decision Tree Decision Boundary (Breast Cancer Data)")
