...
def plot_decision_boundary(X, y, model, title):
    ...
    plt.show(block=True)  # Force Matplotlib to open the plot window
...
def synthetic_test():
    ...
    plot_decision_boundary(X_synthetic, y_synthetic, model, 
                           "Logistic Regression Decision Boundary (Synthetic Data)")
...
def real_data_test():
    ...
    plot_decision_boundary(X, y, model, 
                           "Logistic Regression Decision Boundary (Breast Cancer Data)")
